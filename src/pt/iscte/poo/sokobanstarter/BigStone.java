...
public class BigStone extends Caixote implements Linkable {

	public BigStone(Point2D Coordenadas) {
		super(Coordenadas);
	}
...
//		for (GameElement buraco : elementsAtPosition) {
//			for (GameElement palete : elementsAtPosition) {
